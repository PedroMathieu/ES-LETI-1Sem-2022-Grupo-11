...
public class ServerTests {
    ...
    public void testDateConversion() throws Exception {
        ...
        tests.add(ApiTestUtils.request("GET", "/personalCalendar/jphjs/year/11/3"));
        tests.add(ApiTestUtils.request("GET", "/personalCalendar/jphjs/2022/november/3"));
        tests.add(ApiTestUtils.request("GET", "/personalCalendar/jphjs/2022/11/three"));
    ...
    public void testInvalidOwner() throws Exception {
        ApiTestUtils.TestResponse res = ApiTestUtils.request("GET", "/personalCalendar/xx/2022/11/3");
    ...
    public void testDateValidation() throws Exception {
        ...
        List<ApiTestUtils.TestResponse> tests = new ArrayList<>();
        tests.add(ApiTestUtils.request("GET", "/personalCalendar/jphjs/3001/11/3"));
        tests.add(ApiTestUtils.request("GET", "/personalCalendar/jphjs/999/11/3"));
        tests.add(ApiTestUtils.request("GET", "/personalCalendar/jphjs/2023/13/3"));
        tests.add(ApiTestUtils.request("GET", "/personalCalendar/jphjs/2023/0/3"));
        tests.add(ApiTestUtils.request("GET", "/personalCalendar/jphjs/2023/1/32"));
        tests.add(ApiTestUtils.request("GET", "/personalCalendar/jphjs/2023/2/29"));
        tests.add(ApiTestUtils.request("GET", "/personalCalendar/jphjs/2023/4/31"));
        tests.add(ApiTestUtils.request("GET", "/personalCalendar/jphjs/2023/4/0"));
    ...
    public void testLeapYears() throws Exception {
        ApiTestUtils.TestResponse res = ApiTestUtils.request("GET", "/personalCalendar/jphjs/2024/2/29");
    ...
    public void testpersonalCalendarByDayWorksCorrectly() throws Exception {
        ApiTestUtils.TestResponse res = ApiTestUtils.request("GET", "/personalCalendar/jphjs/2022/11/4");
        assertTrue(!res.body.contains("Something wrong in parameters"));
